...
public class OVRDebugInfo : MonoBehaviour
{
    ...
    void UpdateFOV()
    {
        OVRDisplay.EyeRenderDesc eyeDesc = OVRManager.display.GetEyeRenderDesc(VR.XRNode.LeftEye);
    ...
    {
		OVRDisplay.EyeRenderDesc leftEyeDesc = OVRManager.display.GetEyeRenderDesc(VR.XRNode.LeftEye);
		OVRDisplay.EyeRenderDesc rightEyeDesc = OVRManager.display.GetEyeRenderDesc(VR.XRNode.RightEye);

		float scale = VR.XRSettings.eyeTextureResolutionScale;
